      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="relative bg-white border border-gray-200 rounded-2xl p-5 shadow-lg">
          ...
          <div className="text-center mb-5 pt-1">
            ...
            <h2 className="text-xl font-bold tracking-tight text-gray-900 mb-1">Create an account</h2>
            <p className="text-xs text-gray-500">Sign up to compare caterers and request quotes.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div>
              <label className="block text-[10px] font-semibold text-gray-500 mb-1 uppercase tracking-wide">Full Name</label>
              <input
                type="text"
                value={name}
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-[10px] font-semibold text-gray-500 mb-1 uppercase tracking-wide">Password</label>
                <input
                  type="password"
                  value={password}
              ...
              <div>
                <label className="block text-[10px] font-semibold text-gray-500 mb-1 uppercase tracking-wide">Confirm</label>
                <input
                  type="password"
          ...
          <p className="mt-4 text-center text-xs text-gray-500 border-t border-gray-100 pt-4">
            Already have an account? <Link to="/login" className="font-semibold text-gray-900 hover:text-amber-500 transition-colors">Log in</Link>
          </p>
        </div>
      </div>
    </div>
